...
enum CallPalette {
    ...
    VERMELHO("vermelho", ChatFormatting.DARK_RED, ChatFormatting.RED,
            BossEvent.BossBarColor.RED,
            new Vector3f(0.32F, 0.0F, 0.0F), new Vector3f(0.82F, 0.02F, 0.02F)),
    AZUL("azul", ChatFormatting.DARK_BLUE, ChatFormatting.BLUE,
            BossEvent.BossBarColor.BLUE,
            new Vector3f(0.02F, 0.04F, 0.52F), new Vector3f(0.08F, 0.28F, 0.95F)),
    VERDE("verde", ChatFormatting.GREEN, ChatFormatting.YELLOW,
            BossEvent.BossBarColor.GREEN,
            new Vector3f(0.08F, 0.85F, 0.18F), new Vector3f(0.62F, 1.0F, 0.2F)),
    ROXO("roxo", ChatFormatting.DARK_PURPLE, ChatFormatting.LIGHT_PURPLE,
            BossEvent.BossBarColor.PURPLE,
            new Vector3f(0.24F, 0.0F, 0.42F), new Vector3f(0.5F, 0.06F, 0.72F)),
