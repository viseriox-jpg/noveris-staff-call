...
- `/novecall historico <player> [página]` — mostra o histórico em páginas de oito registros.
- `/novecall historico apagar <player>` — solicita a exclusão do histórico, com confirmação clicável válida por 30 segundos.
